...
- first, having a `POSIXct` object guarantees the conformity of the date, and gives to the user the possibility to extract time informaiton using R methods without any error,
- second, this object carries all the redondant information sometimes requested by the data-calls.
...
```
More complex time manipulation are available using the `lubridate` R package.
