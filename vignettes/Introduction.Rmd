...
Regarding the conformity checks of the landings object, there are two issues. 
First the new `landings` slots is not validated during the object initilization,
and there is no assessement of the number of objects in each slots: they should
have the same size.
